...
export const CreateUrlResponseSchema = Type.Object({
  ...
  customAlias: Type.Optional(
    Type.Boolean({
      description: 'Custom alias for the URL. This field will set to true if the user sets the custom alias',
      default: false
    })
  ),
  userId: Type.String({ description: 'The user ID of the user who created the URL' }),
  clicks: Type.Number({ description: 'The number of clicks on the URL', default: 0 })
});
