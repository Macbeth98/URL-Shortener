...
export const GetUrlQuerySchema = Type.Object({
  skip: Type.Optional(Type.Number({ description: 'The number of documents to skip', default: 0 })),
  limit: Type.Optional(Type.Number({ description: 'The number of documents to return', default: 50 })),
  shortUrl: Type.Optional(Type.String({ description: 'The shortened URL' })),
